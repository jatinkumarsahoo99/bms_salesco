...
class CommercialMasterAutoIdDetailsView extends StatelessWidget {
                                  ...
                                  children: [
                                          ...
                                          () => Padding(
                                            ...
                                            child:
                                                DropDownField.formDropDown1WidthMap(
                                                    controllerX.loadModel?.value
                                                            ?.loadData?.lstLanguage ??
                                                        [], (data) {
                                                  ...
                                                  child: DropDownField
                                                      .formDropDown1WidthMap(
                                                          controllerX
                                                                  ...
                                                                  ?.lstRevenuetype ??
                                                              [], (data) {
                                                    controllerX.selectRevenue?.value =
                                                        data;
                                                    controllerX.getRevenueLeave(
                                                        data.key ?? "");
                                                  }, "Revenue", 0.15,
                                                          searchReq: true,
                                                          labelBold: true,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                            child: buildRowText(
                                                "Client", controllerX.client)),
                                        Expanded(
                                            child: buildRowText(
                                                "Territory", controllerX.temitory)),
                                      ],
                                    ),
                                    Row(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        Expanded(
                                            child: buildRowText(
                                                "Brand", controllerX.brand)),
                                        Expanded(
                                            child: buildRowText(
                                                "Tape Type", controllerX.tapeType)),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Expanded(
                                            child: buildRowText(
                                                "Language", controllerX.language)),
                                        Expanded(
                                            child: buildRowText(
                                                "Duration", controllerX.duration1)),
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                            child: buildRowText(
                                                "Provider", controllerX.providers)),
                                        Expanded(child: Container())
                                      ],
                                    ),
                                    /*Row(
                                    ...
                                    Stack(
                                      children: [
                                        Container(
                                          // height: 200,
                                          margin: EdgeInsets.fromLTRB(6, 20, 1, 10),
                                          padding: EdgeInsets.only(bottom: 10),
                                          decoration: BoxDecoration(
                                              border: Border.all(color: Colors.grey)),
                                          child: Padding(
                                            padding: const EdgeInsets.only(top: 12.0,bottom: 0,right: 0,left: 0),
                                            child: Column(
                                              children: [
                                                Row(
                                                  mainAxisAlignment:
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Expanded(
                                                        child: buildRowText1("Language",
                                                            controllerX.language)),
                                                    Expanded(
                                                        child: buildRowText1("Censorship",
                                                            controllerX.censorship)),
                                                  ],
                                                ),
                                                SizedBox(
                                                  height: 4,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: buildRowText1(
                                                          "Revenue", controllerX.revenue),
                                                    ),
                                                    Expanded(
                                                        child: buildRowText1("Sec Type",
                                                            controllerX.secType)),
                                                  ],
                                                ),
                                                Row(
  ...
  Widget buildRowText1(String title1, RxString value1) {
    return Padding(
