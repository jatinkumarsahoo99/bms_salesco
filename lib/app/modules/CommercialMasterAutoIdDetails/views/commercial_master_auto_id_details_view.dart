            ...
            builder: (BuildContext context, BoxConstraints constraints) {
              return SizedBox(
                ...
                child: Padding(
                  ...
                  child: GetBuilder<CommercialMasterAutoIdDetailsController>(
                    assignId: true,
                    id: "all",
                    builder: (controllerX) {
                      return Column(
