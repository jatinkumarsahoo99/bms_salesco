...
class SearchPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SearchController>(
        key: key,
        id: "initialData",
        init: SearchController(strViewName, screenName, isPopUp: isPopup, actionableSearch: actionableSearch, actionableMap: actionableMap),
        builder: (controller) {
          if (controller.grid != null && controller.grid!.variances!.isNotEmpty) {
            return Scaffold(
                ...
                appBar: (isAppBarReq != null && isAppBarReq == true)
                    ? AppBar(
                        title: Text(appBarName != null ? (appBarName ?? "") + " - " + "Search" : "Search",
                          ...
                          children: [
                            ...
                            DropDownField.formDropDown1Width(
                              ...
                              (value) async {
                                ...
                                controller.selectVarianceId = int.parse(value?.key!);
                                await controller.getVaraince(int.parse(value.key!));
                              },
                              "Variance",
                              0.3,
                            ...
                            child: Container(
                              ...
                              child: GetBuilder<SearchController>(
                                ...
                                builder: (controller) => DataTable2(
                                  ...
                                  //     ),
                                  // ],
                                  rows: controller.searchQuery == "" ? controller.searchGridRows : controller.filterSearchGridRows,
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: ButtonBar(
                              ...
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                for (var btn in ["Execute", "Clear", "Add Variance", "Delete Variance", "Exit"])
                                  FormButtonWrapper(
                                    btnText: btn,
