                        ...
                        children: [
                          ...
                          DropDownField.simpleDropDownwithWidthRatio(
                            [
                              ...
                              DropDownValue(key: "Select Variance", value: "BIG Vararaince"),
                            ],
                            (value) => null,
                            "Variant",
                            0.3,
                        ...
                        child: Card(
                          child: GetBuilder<SearchController>(
                              ...
                              builder: (controller) => PlutoGrid(
                                  ...
                                  columns: [
                                    for (var key in (controller.grid!.variances![0].toJson()).keys)
                                      PlutoColumn(
                                          title: key.toString(),
                                          readOnly: true,
                                          enableSorting: true,
                                          enableRowChecked: key == "selected" ? true : false,
                                          enableRowDrag: false,
                                          enableEditingMode: false,
                                          enableDropToResize: true,
                                          enableContextMenu: false,
                                          width: Utils.getColumnSize(key: key, value: controller.grid!.variances![0].toJson()[key]),
                                          enableAutoEditing: false,
                                          hide: (key == "dataType" || key == "tableName" || key == "valueColumnName"),
