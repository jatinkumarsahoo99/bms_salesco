                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  DateWithThreeTextField(
                                    title: "Util As ON",
                                    mainTextController:
                                        controllerX.utilAsOnDateController,
                                    widthRation: .1,
                                    isEnable: controllerX.isEnable,
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  DateWithThreeTextField(
                                    title: "From Date",
                                    mainTextController:
                                        controllerX.fromDateController,
                                    widthRation: .1,
                                    isEnable: controllerX.isEnable,
                                  ),
                                  DateWithThreeTextField(
                      ...
                      child: GetBuilder<DealRecoSummaryController>(
                          ...
                          builder: (controllerX) {
                            return (controllerX.dealRecoSummaryModel != null &&
                                    controllerX.dealRecoSummaryModel?.gentare !=
                                        null &&
                                    (controllerX.dealRecoSummaryModel?.gentare
                                                ?.length ??
                                            0) >
