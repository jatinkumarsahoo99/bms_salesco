...
class TapeIDCampaignView extends StatelessWidget {
    ...
    return Scaffold(
      body: SizedBox(
        ...
        child: Padding(
          ...
          child: GetBuilder(
              init: Get.put(TapeIDCampaignController()),
              builder: (controller) {
                return Column(
                        ...
                        return Wrap(
                          ...
                          children: [
                            ...
                            InputFields.formFieldDisable1(
                              hintTxt: "Client",
                              value: controller
                                      .loadModel?.tapeIdDetails.clientName ??
                                  "",
                              widthRatio: .15,
                              txtColor: Colors.black,
                              leftPad: 0,
                            ...
                            InputFields.formFieldDisable1(
                              hintTxt: "Agency",
                              value: controller
                                      .loadModel?.tapeIdDetails.agencyName ??
                                  "",
                              widthRatio: .15,
                              leftPad: 0,
                              txtColor: Colors.black,
                            ...
                            InputFields.formFieldDisable1(
                              hintTxt: "Brand",
                              value: controller
                                      .loadModel?.tapeIdDetails.brandName ??
                                  "",
                              widthRatio: .15,
                              leftPad: 0,
                              txtColor: Colors.black,
                            ...
                            DateWithThreeTextField(
                              ...
                              onFocusChange: (h) {
                                var tempDate =
                                    DateFormat("dd-MM-yyyy").parse(h);
                                controller.startDate = tempDate.subtract(
                                    Duration(days: (tempDate.day) - 1));
                            ...
                            InputFields.formFieldDisable1(
                              hintTxt: "Created By",
                              value: controller
                                      .loadModel?.tapeIdDetails.loginName ??
                                  "",
                              widthRatio: .15,
                              leftPad: 0,
                              txtColor: Colors.black,
                            ...
                            Expanded(
                              child: Obx(() {
                                ...
                                if (controller.selectedTab.value == 0) {
                                  ...
                                  return DataGridFromMap3(
                                      mapData:
                                          controller.camoaignHistoryList.value,
                                      formatDate: false,
                                      hideCode: false);
                                } else if (controller.selectedTab.value == 3) {
                                  return DataGridFromMap3(
                                      mapData:
                                          controller.tapeIdCampaignList.value,
                                      formatDate: false,
                                      hideCode: false);
                                } else {
                                  return Container(
