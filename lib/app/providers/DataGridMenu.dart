    ...
    switch (selected) {
      ...
      case DataGridMenuItem.export:
        ...
        Get.find<ConnectorControl>().POSTMETHOD(
          ...
          json: {
            // "JsonData": jsonEncode(stateManager.rows.map((e) => e.toJsonWithRawData(hideKeys: removeKeysFromFile ?? [])).toList())
      ...
      case DataGridMenuItem.print:
        ...
        Get.find<ConnectorControl>().POSTMETHOD_FORMDATAWITHTYPE1(
          ...
          json: {
           /* "JsonData": jsonEncode(
                stateManager.rows.map((e) =>
                    e.toJsonWithRawData(hideKeys: removeKeysFromFile ?? []))
                    .toList())*/
            "JsonData": jsonEncode(data)
          },
        );
