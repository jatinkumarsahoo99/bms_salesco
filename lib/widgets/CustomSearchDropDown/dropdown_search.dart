...
import 'package:bms_salesco/widgets/CustomSearchDropDown/src/properties/icon_button_props.dart';
import 'package:bms_salesco/widgets/CustomSearchDropDown/src/properties/selection_list_view_props.dart';
// import 'package:bms_programming/widgets/CustomSearchDropDown/dropdown_search.dart';
    ...
    return Row(
      ...
      children: <Widget>[
        if (widget.showClearButton == true && getSelectedItems.isNotEmpty)
          IconButton(
            icon: widget.clearButtonProps?.icon ?? const Icon(Icons.clear, size: 24),
            ...
            padding: widget.clearButtonProps?.padding ?? const EdgeInsets.all(8.0),
            ...
            mouseCursor: widget.clearButtonProps?.mouseCursor ?? SystemMouseCursors.click,
